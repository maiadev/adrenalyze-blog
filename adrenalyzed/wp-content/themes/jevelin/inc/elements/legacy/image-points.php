...
class vcj_image_points extends WPBakeryShortCode {
  ...
  array (
    ...
    public function _html( $atts, $content ) {
        ...
        include( trailingslashit( get_template_directory() ) . '/framework-customizations/extensions/shortcodes/shortcodes/image-points/views/view.php' );
        include( trailingslashit( get_template_directory() ) . '/framework-customizations/extensions/shortcodes/shortcodes/image-points/static.php' );
