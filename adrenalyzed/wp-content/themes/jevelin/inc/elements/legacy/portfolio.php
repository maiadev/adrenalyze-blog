...
class vcj_portfolio extends WPBakeryShortCode {
  ...
  array (
    ...
    public function _html( $atts, $content ) {
        ...
        include( trailingslashit( get_template_directory() ) . '/framework-customizations/extensions/shortcodes/shortcodes/portfolio/views/view.php' );
        include( trailingslashit( get_template_directory() ) . '/framework-customizations/extensions/shortcodes/shortcodes/portfolio/static.php' );
