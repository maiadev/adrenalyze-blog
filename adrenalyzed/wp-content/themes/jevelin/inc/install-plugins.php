...
if( is_admin() && !function_exists('jevelin_register_required_plugins') ) :
    ...
    function jevelin_register_required_plugins() {
        ...
        tgmpa(array(
            ...
            array(
                'name'      => esc_html__( 'MailChimp for WordPress (optional, used in some Jevelin demos)', 'gillion' ),
                'slug'      => 'mailchimp-for-wp',
                'required'  => false,
            ),

            array(
                'name'      => esc_html__( 'WP Instagram Widget (optional, used in some Jevelin demos)', 'gillion' ),
